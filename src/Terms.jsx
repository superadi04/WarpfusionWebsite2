    ...
    <>
      <div className=''>
            <h2 className="text-left text-gray-300 text-4xl font-bold leading-7 sm:tracking-tight mr-4 pr-2 mb-7">
                WarpVideo AI Terms of Service
            </h2>
                <p className="text-left leading-7 text-gray-500 sm:tracking-tight mr-4 pr-2 mb-5">
                    This agreement outlines the rules and regulations for using the website at https://WarpVideoai.cloud and any associated services offered by WarpVideo AI.
                </p>
                <p className="text-left leading-7 text-gray-500 sm:tracking-tight mr-4 pr-2 mb-5">
                    By accessing the website at https://WarpVideoai.cloud, you consent to follow these rules and agree to adhere to all relevant laws and regulations. If you disagree with any part of these rules, you must not use or access this website or any services offered by WarpVideo AI.
                </p>
                <p className="text-left leading-7 text-gray-500 sm:tracking-tight mr-4 pr-2 mb-5">
                    WarpVideo AI retains the right to modify these terms at any time, and changes will be effective immediately upon updating this page. The latest update to these terms was on December 14, 2023.
                </p>
            <h3 className="text-left text-xl text-gray-300 font-bold leading-7 sm:tracking-tight mr-4 pr-2 mb-5">
                ...
                <ul className='text-left mb-5 ml-10 text-gray-500'>
                    ...
                    <li>Misuse the website or WarpVideo AI's services in a way that could harm our networks or other services;</li>
            ...
            <h3 className="text-left text-xl text-gray-300 font-bold leading-7 sm:tracking-tight mr-4 pr-2 mb-5">
                ...
                <p className="text-left leading-7 sm:tracking-tight mr-4 pr-2 mb-5 text-gray-500">
                    The website and its contents are provided "as is". WarpVideo AI disclaims all warranties and will not be liable for any losses arising from your use of the website. This includes, but is not limited to, loss of data, profit, or business interruptions.                
                </p>
            <h3 className="text-left text-xl text-gray-300 font-bold leading-7 sm:tracking-tight mr-4 pr-2 mb-5">
                Materials Accuracy
            </h3>
            ...
            <p className="text-left leading-7 sm:tracking-tight mr-4 pr-2 mb-5 text-gray-500">
                WarpVideo AI is not responsible for the content of external sites linked to our website. We do not endorse, guarantee, or assume liability for any content on these external sites. Visiting any linked sites is at your own risk.
            </p>
            ...
            <p className="text-left leading-7 sm:tracking-tight mr-4 pr-2 mb-5 text-gray-500">
                WarpVideo AI reserves the right to terminate or suspend your access to the website at any time, without notice, for any breach of these terms. This termination may include denying access to any services provided through the website.
            </p>
